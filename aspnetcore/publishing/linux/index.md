---
title: Set up a Linux hosting environment and deploy to it | Microsoft Docs
...
# Set up a Linux hosting environment and deploy to it

The following articles are available for learning about hosting ASP.NET Core apps on Linux servers.
