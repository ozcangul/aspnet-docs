...
In *Views/Instructors/Edit.cshtml*, add a new field for editing the office location:
...
Next, add the code that's executed when the user clicks Save. Replace the EditPost method with the following code, and add a new method that EditPost calls to update the Courses navigation property of the Instructor entity.
...
Add Courses to the Instructors Index view
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. literalinclude::  intro/samples/cu/Views/Instructors/Index.cshtml
  :language: html
  :start-after: snippet_AddCoursesHeading
  :end-before:  snippet_AddCoursesHeading
  :dedent: 8
  :emphasize-lines: 6
...
.. literalinclude::  intro/samples/cu/Views/Instructors/Index.cshtml
  :language: html
  :start-after: snippet_AddCoursesRow
  :end-before:  snippet_AddCoursesRow
  :dedent: 8
  :emphasize-lines: 1-8
...
.. image:: update-related-data/_static/instructor-index-courses.png
   :alt: Instructors Index page with courses
